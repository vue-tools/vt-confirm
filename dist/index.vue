                        ...
                        <transition name="ui-confirm-zoomOut">
                            <div class="ui-confirm__container" v-show={this.visible}>
                                ...
                                <div class="ui-confirm__button">
                                    <div class={{"ui-confirm__button--ok": true, "ui-confirm-button--access": this.confirmAccess}} onClick={this.emit.bind(this, true)} onTouchstart={this.confirmHandle.bind(this, 0)} onTouchend={this.confirmHandle.bind(this, 200)}>
                                        {this.$slots.confirmButton || '确定'}
                                    </div>
                                    <div class={{"ui-confirm__button--cancel": true, "ui-confirm-button--access": this.cancelAccess}} onClick={this.emit.bind(this, false)} onTouchstart={this.cancelHandle.bind(this, 0)} onTouchend={this.cancelHandle.bind(this, 200)}>
